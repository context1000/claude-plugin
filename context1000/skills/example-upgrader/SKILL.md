...
/context1000:guide "Migrate to <New API> from <Old API>" --audience <role>
```
...
/context1000:rule "Use <Current API> for <Purpose>" --severity warn --scope <area>
```
...
5. Create migration guide if needed:
   ```bash
   /context1000:guide "Migrate gRPC Client to v1.63" --audience backend
   ```
