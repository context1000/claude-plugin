...
```bash
/context1000/guide "<Guide Title>" --audience <target>
```
...
1. ADR: "Extract Billing Service from Monolith"
   Command: /context1000/adr "Extract Billing Service from Monolith" --status proposed --template madr --scope billing

2. GUIDE: "Service Migration Procedure"
   Command: /context1000/guide "Service Migration Procedure" --audience backend

3. RULE: "Service Deployment Requirements"
   Command: /context1000/rule "Service Deployment Requirements" --severity required --scope platform
```
...
1. ADR: "Adopt OpenTelemetry for Observability"
   Command: /context1000/adr "Adopt OpenTelemetry for Observability" --status proposed --template madr --scope platform

2. RULE: "Telemetry Standards"
   Command: /context1000/rule "Telemetry Standards" --severity warn --scope all

3. GUIDE: "Integrating OpenTelemetry in Services"
   Command: /context1000/guide "Integrating OpenTelemetry in Services" --audience all
```
...
1. ADR: "Implement Zero-Trust Security Model"
   Command: /context1000/adr "Implement Zero-Trust Security Model" --status proposed --template madr --scope security

2. RULE: "Authentication Requirements"
   Command: /context1000/rule "Authentication Requirements" --severity required --scope security

3. GUIDE: "Implementing Service-to-Service Authentication"
   Command: /context1000/guide "Implementing Service-to-Service Authentication" --audience backend
```
