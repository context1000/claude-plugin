...
/context1000:rule "All API endpoints must use authentication"
/context1000:rule "Database queries must use prepared statements" --severity required
/context1000:rule "Components must have unit tests" --severity warn
/context1000:rule "Inclusive terminology in code & docs" --severity required

# Project-scoped rules
/context1000:rule "Use TypeScript for all new files" --project frontend-app
/context1000:rule "All mutations require transactions" --project user-service --severity required
```
...
- Use `/context1000:adr` to document WHY a rule exists
- Use `/context1000:guide` to document HOW to follow a rule
- Use `/context1000:rfc` to propose new rules or rule changes
