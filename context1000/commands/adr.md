...
/context1000:adr "Choose database technology for user service"
/context1000:adr "Adopt gRPC for inter-service calls" --status proposed
/context1000:adr "Select frontend framework" --status draft --scope frontend

# Project-scoped ADR
/context1000:adr "Choose authentication method" --project user-service
/context1000:adr "API versioning strategy" --project mobile-app --status draft
```
