...
```bash
/context1000:project "my-service"
/context1000:project "frontend-app"
/context1000:project "data-pipeline"
```
...
2. Use /context1000:adr to create architecture decisions for this project
3. Use /context1000:rfc to create proposals for this project
4. Use /context1000:guide to create how-to documentation
5. Use /context1000:rule to create project-specific rules
```
...
- Spaces: "my project" ❌
- Special characters: "project\_#1" ❌
